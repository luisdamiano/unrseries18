...
```{r, results = "asis"}
z_mat <- matrix(z, ncol = 12, byrow = TRUE)
...
\[
\hat{\mathcal{T}}_t = \frac{1}{24}\left(Z_{t-6} + 2\sum_{i = -5}^{5}{Z_{t-i}} + Z_{t+6}\right) \qquad \hat{\mathcal{S}}_j = \frac{\frac{1}{p} \sum_{i = 1}^{p}{Z_{ij}}}{\frac{1}{T}\sum_{t = 1}^{T}{Z_t}}, j = 1, 2, \dots, 12 \qquad \hat{\mathcal{E}}_t = \frac{Z_t}{\hat{\mathcal{T}}_t \times \hat{\mathcal{S}}_j}
\]
...
* Diferenciación estacional de orden $D = 1$.
* Media móvil estacional de orden $Q = 1$.
